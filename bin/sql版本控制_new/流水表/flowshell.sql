...
part_num,
type as name
from ${pub_db}.maintnance
union all
select '附件' as type,
part_num,
name_chinese as name
from  ${pub_db}.enclosure
union all 
select '高流件' as type,
part_num,
...
bwjk,mileage,primary_classification,second_level_classification
from
...
,quantity,sales_amount,age,bnjk,bwjk,mileage,primary_classification,second_level_classification
from flow_tmp)t1
