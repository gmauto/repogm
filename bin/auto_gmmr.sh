...
mapping=hdfs://nameservice1/user/hive/warehouse_ext/DL/ipsos/dim/mapping

#ori public目录 公共访问路径 存放kpi计算需要的表
#TB_FACT=hdfs://ns1/user/ori/public/auto/tb4kpi/fact
#TB_FACT=hdfs://ns1/user/ori/public
TB_FACT=hdfs://nameservice1/user/hive/warehouse_ext/DL/ipsos
...
#存放源数据更换分隔符之后的路径
PATH_CLAIM=hdfs://nameservice1/user/hive/warehouse_ext/DL/ipsos/raw_tmp/claim_table
PATH_CUSTOMER=hdfs://nameservice1/user/hive/warehouse_ext/DL/ipsos/raw_tmp/customer_table
PATH_DOSS=hdfs://nameservice1/user/hive/warehouse_ext/DL/ipsos/raw_tmp/doss_table
PATH_ORDER=hdfs://nameservice1/user/hive/warehouse_ext/DL/ipsos/raw_tmp/order_table
...
PATH_LABEL_DELETE_ORDER=hdfs://nameservice1/user/hive/warehouse_ext/DL/ipsos/auto/label/order/delete
...
PATH_LABEL_FM=hdfs://nameservice1/user/hive/warehouse_ext/DL/ipsos/label/order/first_maintnance
