...
#替换数据中的分隔符 将 “，” 替换为 \001\
PORMAT_JAR=/home/ipsos/general/bin/format.jar
FORMAT_MAINCLASS=com.changxi.main.AutoRun

#日志路径
log_path=/home/ipsos/general/log

#源数据本地存放目录
LOCAL_PATH_PART=/home/ipsos/general/data/part
LOCAL_PATH_CLAIM=/home/ipsos/general/data/claim
LOCAL_PATH_CUSTOMER=/home/ipsos/general/data/customer
LOCAL_PATH_DOSS=/home/ipsos/general/data/doss
LOCAL_PATH_ORDER=/home/ipsos/general/data/order

#源数据集群存放目录
PATH_PART_R=private/auto/raw_r/part
PATH_CLAIM_R=private/auto/raw_r/claim
PATH_CUSTOMER_R=private/auto/raw_r/customer
PATH_DOSS_R=private/auto/raw_r/doss
PATH_ORDER_R=private/auto/raw_r/order

#存放源数据更换分隔符之后的路径
PATH_PART=private/auto/raw/part
PATH_CLAIM=private/auto/uniq/claim
PATH_CUSTOMER=private/auto/uniq/customer
PATH_DOSS=private/auto/raw/doss
PATH_ORDER=private/auto/raw/order

#uniq
UNIQ_JAR=/home/ipsos/general/bin/uniq.jar
MAIN_CLASS_UNIQ=com.changxi.uniq.main.Main
PATH_UNIQ_OUT_DOSS=private/auto/uniq/doss/chev700
PATH_UNIQ_OUT_CLAIM=private/auto/uniq/claim/chev700
PATH_UNIQ_OUT_CUSTOMER=private/auto/uniq/customer/chev700
PATH_UNIQ_OUT_ORDER=private/auto/uniq/order/chev700

#delete
DELETE_JAR=delete-useless.jar
DELETE_MAINCLASS=com.changxi.delete.main.Main
PATH_LABEL_DELETE=private/auto/label/order/delete

#label
LABEL_JAR=label.jar
FM_MAINCLASS=com.changxi.label.claimAndFirstMaintenance.main.Main
FIX_MAINCLASS=com.changxi.label.maintType.main.Main
OTHER_MAINCLASS=com.changxi.label.others.main.Main
DOSS_MAINCLASS=com.changxi.label.doss.main.Main
...
function format_delimiter_part(){
 ...
 echo ${out_path}
 hadoop fs -rm -r ${out_path}
 hadoop jar ${PORMAT_JAR} ${FORMAT_MAINCLASS} 27,no ${in_path} ${out_path}
}
...
function delete_useless(){
 ...
 date=$1
 in_path=${PATH_ORDER}/${date}
 out_path=${PATH_LABEL_DELETE}/${date}
 echo ${in_path}
 echo ${out_path}
 hadoop fs -rm -r ${out_path}
 hadoop jar ${DELETE_JAR} ${DELETE_MAINCLASS} -files conf/CHE -Dmapreduce.job.reduces=${reduce_num} ${in_path} ${out_path}
}
...
function label_fm(){
 ...
 date=$1
 in_path="${PATH_LABEL_DELETE}/${date} ${PATH_CLAIM}/*"
...
function label_fix(){
 ...
 echo ${out_path}
 hadoop fs -rm -r ${out_path}
 hadoop jar ${LABEL_JAR} ${FIX_MAINCLASS} -files conf/part -Dmapreduce.job.reduces=${reduce_num} -Dmapreduce.reduce.memory.mb=8192 -Dmapreduce.reduce.java.opts=-Xmx6964m ${in_path} ${out_path}
}
...
function label_other(){
 ...
 date=$1
 in_path="${PATH_LABEL_FIX}/${date} ${PATH_DOSS}/* ${PATH_CUSTOMER}/*"
 out_path=${PATH_LABEL_OTHER}/${date}
 echo ${in_path}
 echo ${out_path}
 hadoop fs -rm -r ${out_path}
 hadoop jar ${LABEL_JAR} ${OTHER_MAINCLASS} -files conf/mark -Dmapreduce.job.reduces=${reduce_num} ${in_path} ${out_path}
}
...
function label_doss(){
 ...
 date=$1
 in_path=${PATH_DOSS}/${date}
 out_path=${PATH_LABEL_DOSS}/${date}
 echo ${in_path}
 echo ${out_path}
 hadoop fs -rm -r ${out_path}
 hadoop jar ${LABEL_JAR} ${DOSS_MAINCLASS} -files conf/mark_doss,conf/doss_asc -Dmapreduce.job.reduces=0 ${in_path} ${out_path}
}
...
function update_assistant() {
 hadoop fs -rm -r private/auto/assistant/enclosure/*
 hadoop fs -rm -r private/auto/assistant/engine_oil/*
 hadoop fs -rm -r private/auto/assistant/filter/*
 hadoop fs -rm -r private/auto/assistant/high_flow_parts/*
 hadoop fs -rm -r private/auto/assistant/maintnance/*
 hadoop fs -rm -r private/auto/assistant/mark_order/*
 hadoop fs -rm -r private/auto/assistant/mark_doss/*


 hadoop fs -put /home/ipsos/general/data/enclosure/* private/auto/assistant/enclosure/
 hadoop fs -put /home/ipsos/general/data/engine_oil/* private/auto/assistant/engine_oil
 hadoop fs -put /home/ipsos/general/data/filter/* private/auto/assistant/filter
 hadoop fs -put /home/ipsos/general/data/high_flow_parts/* private/auto/assistant/high_flow_parts
 hadoop fs -put /home/ipsos/general/data/maintnance/* private/auto/assistant/maintnance
 hadoop fs -put /home/ipsos/general/bin/conf/mark private/auto/assistant/mark_order
 hadoop fs -put /home/ipsos/general/bin/conf/mark_doss private/auto/assistant/mark_doss
}
...
function check_new_mark() {
 ...
 hive -e "
  ...
  where a.mon='${date}';
 " >/home/ipsos/general/compare/order_compare 2>${log_path}/compare_order
 ...
 hive -e "
  ...
  where a.mon='${date}' ;
  " >/home/ipsos/general/compare/doss_compare 2>${log_path}/compare_doss
...
function cre_asc_baseline(){
 hive -e "
  ...
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/asc_baseline/'
 "
}
...
function cre_base_kpi(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/base_kpi/'
 "
}
#创建customer表
function cre_customer() {
 hive -e "
  ...
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/raw/customer/'
 "
}
...
function cre_distributor(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/assistant/distributor/'
 "
}
...
function cre_flow(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/flow/'
 "
}
...
function cre_claim() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/raw/claim/'
 "
}
...
function cre_doss() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/raw/doss/'
 "
}
...
function cre_order() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/raw/order/'
 "
}
...
function cre_part() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/raw/part/'
 "
}
...
function cre_customer_uniq() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/uniq/customer/'
 "
}
...
function cre_claim_uniq() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/uniq/claim/'
 "
}
...
function cre_doss_uniq() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/uniq/doss/'
 "
}
...
function cre_order_uniq() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/uniq/order/'
 "
}
...
function cre_part_uniq() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/uniq/part/'
 "
}
...
hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/label/order/other/'
 "
}
...
hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/label/order/bnwjk/'
 "
}
...
hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/assistant/enclosure/'
 "
}
...
function cre_high_flow_parts(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/assistant/high_flow_parts/'
 "
}
...
hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/assistant/customer_mark/'
 "
}
...
hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/assistant/db_base/'
 "
}
function cre_filter(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/assistant/filter/'
 "
}
...
hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/assistant/engine_oil/'
 "
}
...
function cre_maintnance(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/assistant/maintnance/'
 "
}
...
function cre_kpi_total(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_total/'
 "
}
...
function cre_kpi_a_level(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_a_level/'
 "
}
...
function cre_kpi_b_level(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_b_level/'
 "
}
...
function cre_kpi_agetype(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_agetype/'
 "
}
...
function cre_kpi_bnbw(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_bnbw/'
 "
}
...
function cre_kpi_a_agetype(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_a_agetype/'
 "
}
...
function cre_kpi_b_agetype(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_b_agetype/'
 "
}
...
function cre_kpi_a_bnbw(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_a_bnbw/'
 "
}
...
function cre_kpi_b_bnbw(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_b_bnbw/'
 "
}
...
function cre_kpi_total_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_total_chev/'
 "
}
...
function cre_kpi_a_level_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_a_level_chev/'
 "
}
...
function cre_kpi_b_level_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_b_level_chev/'
 "
}
...
function cre_kpi_agetype_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_agetype_chev/'
 "
}
...
function cre_kpi_bnbw_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_bnbw_chev/'
 "
}
...
function cre_kpi_a_agetype_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_a_agetype_chev/'
 "
}
...
function cre_kpi_b_agetype_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_b_agetype_chev/'
 "
}
...
function cre_kpi_a_bnbw_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_a_bnbw_chev/'
 "
}
...
function cre_kpi_b_bnbw_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/kpi_b_bnbw_chev/'
 "
}
...
function cre_label_doss(){
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/label/doss/';
 "
}
...
function cre_mark_order(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/assistant/mark_order/'
 "
}
...
function cre_mark_doss(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/assistant/mark_doss/'
 "
}
...
function cre_jipanshu(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/ipsos/private/auto/kpi/jipanshu/'
 "
 }
#cre_kpi_total
#cre_kpi_a_level
