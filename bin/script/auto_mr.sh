...
PATH_PART_R=${TB_FACT}/auto/raw_csv/part
PATH_CLAIM_R=${TB_FACT}/auto/raw_csv/claim
PATH_CUSTOMER_R=${TB_FACT}/auto/raw_csv/customer
PATH_DOSS_R=${TB_FACT}/auto/raw_csv/doss
PATH_ORDER_R=${TB_FACT}/auto/raw_csv/order
...
#PATH_PART=${TB_FACT}/auto/raw/part
...
#PATH_UNIQ_OUT_DOSS=${TB_FACT}/auto/uniq/doss/
PATH_UNIQ_OUT_DOSS=${TB_FACT_DOSS}
#PATH_UNIQ_OUT_CLAIM=${TB_FACT}/auto/uniq/claim/
PATH_UNIQ_OUT_CLAIM=${TB_FACT_CLAIM_UNIQ}
#PATH_UNIQ_OUT_CUSTOMER=${TB_FACT}/auto/uniq/customer/
PATH_UNIQ_OUT_CUSTOMER=${TB_FACT_CUSTOMER_UNIQ}
#PATH_UNIQ_OUT_ORDER=${TB_FACT}/auto/uniq/order/
PATH_UNIQ_OUT_ORDER=${TB_FACT_ORDER}
PATH_UNIQ_OUT_part=${TB_FACT}/auto/uniq/order/

#打删除标签
DELETE_JAR=/home/${user_name}/general/bin/delete-useless.jar
DELETE_MAINCLASS=com.gm.delete.main.Main
PATH_LABEL_DELETE_ORDER=${TB_FACT}/auto/label/order/delete
...
#PATH_LABEL_FM=${TB_FACT}/auto/label/order/first_maintnance
PATH_LABEL_FM=fx/order/combine
PATH_LABEL_FIX=${TB_FACT}/auto/label/order/fix
#PATH_LABEL_FIX=${TB_FACT}/data
#PATH_LABEL_FIX=${TB_FACT}/data1
#PATH_LABEL_OTHER=${TB_FACT}/auto/label/order/other
PATH_LABEL_OTHER=${TB_FACT_LABEL_ORDER}
#PATH_LABEL_DOSS=${TB_FACT}/auto/label/doss
...
function put_raw() {
 ...
 date=$1
 hdfs dfs -rm -r ${PATH_PART_R}/${date}
 hdfs dfs -rm -r ${PATH_CLAIM_R}/${date}
 hdfs dfs -rm -r ${PATH_CUSTOMER_R}/${date}
 hdfs dfs -rm -r ${PATH_DOSS_R}/${date}
 hdfs dfs -rm -r ${PATH_ORDER_R}/${date}

 hdfs dfs -mkdir -p ${PATH_ORDER_R}/${date}
 hdfs dfs -mkdir -p ${PATH_CLAIM_R}/${date}
 hdfs dfs -mkdir -p ${PATH_CUSTOMER_R}/${date}
 hdfs dfs -mkdir -p ${PATH_DOSS_R}/${date}
 hdfs dfs -mkdir -p ${PATH_PART_R}/${date}

 hdfs dfs -put ${LOCAL_PATH_PART}/${date}/* ${PATH_PART_R}/${date}
 hdfs dfs -put ${LOCAL_PATH_CLAIM}/${date}/* ${PATH_CLAIM_R}/${date}
 hdfs dfs -put ${LOCAL_PATH_CUSTOMER}/${date}/* ${PATH_CUSTOMER_R}/${date}
 hdfs dfs -put ${LOCAL_PATH_DOSS}/${date}/* ${PATH_DOSS_R}/${date}
 hdfs dfs -put ${LOCAL_PATH_ORDER}/${date}/* ${PATH_ORDER_R}/${date}
}
...
#uniq 0,1,10,46 ${TB_FACT}/auto/raw/customer/chev700/ ${TB_FACT}/auto/uniq/customer/chev700 > ../log/uniq_cus.log 2>&1
#uniq 7,12 ${TB_FACT}/auto/raw/doss/chev700/ ${TB_FACT}/auto/uniq/doss/chev700 > ../log/uniq_doss.log 2>&1
#uniq 3,27 ${TB_FACT}/auto/raw/order/chev700/ ${TB_FACT}/auto/uniq/order/chev700 > ../log/uniq_order.log 2>&1
#uniq claim所有字段 ${TB_FACT}/auto/raw/order/chev700/ ${TB_FACT}/auto/uniq/order/chev700 > ../log/uniq_order.log 2>&1
...
function uniq_cus(){
date=$1
#in="${TB_FACT}/auto/uniq/customer/201701_201703 ${TB_FACT}/auto/uniq/customer/chev700 ${TB_FACT}/auto/uniq/customer/supplement"
#out="${TB_FACT}/auto/uniq/customer/combine"
...
function uniq_doss(){
date=$1
#in="${TB_FACT}/auto/uniq/doss/chev700 ${TB_FACT}/auto/raw/doss/201701_201703 ${TB_FACT}/auto/raw/doss/supplement"
#out="${TB_FACT}/auto/raw/doss/combine"
in=${PATH_DOSS}/${date}
...
function uniq_order(){
date=$1
#in="${TB_FACT}/auto/uniq/order/chev700 ${TB_FACT}/auto/raw/order/201701_201703 ${TB_FACT}/auto/raw/order/supplement"
#out="${TB_FACT}/auto/raw/order/combine"
in=${PATH_ORDER}/${date}
...
function uniq_claim(){
date=$1
#in="${TB_FACT}/auto/uniq/claim/201701_201703 ${TB_FACT}/auto/uniq/claim/chev700 ${TB_FACT}/auto/uniq/claim/supplement"
#out="${TB_FACT}/auto/uniq/claim/combine"
in=${PATH_CLAIM}/${date}
...
function cre_asc_baseline(){
 hive -e "
  ...
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/asc_baseline/'
 "
}
...
function cre_base_kpi(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/base_kpi/'
 "
}
#创建customer表
function cre_customer() {
 hive -e "
  ...
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/raw/customer/'
 "
}
...
function cre_distributor(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/assistant/distributor/'
 "
}
...
function cre_flow(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/flow/'
 "
}
...
function cre_claim() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/raw/claim/'
 "
}
...
function cre_doss() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/raw/doss/'
 "
}
...
function cre_order() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/raw/order/'
 "
}
...
function cre_part() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/raw/part/'
 "
}
...
function cre_customer_uniq() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/uniq/customer/'
 "
}
...
function cre_customer_uniq_2200621() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/uniq/customer_uniq_2200621/'
 "
}
...
function cre_claim_uniq() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/uniq/claim/'
 "
}
...
function cre_claim_uniq_2200621() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/uniq/claim_uniq_2200621/'
 "
}
...
function cre_doss_uniq() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/uniq/doss/'
 "
}
...
function cre_order_uniq() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/uniq/order/'
 "
}
...
function cre_part_uniq() {
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/uniq/part/'
 "
}
...
hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/label/order/other/'
 "
}
...
hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/label/order/bnwjk/'
 "
}
...
hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/assistant/enclosure/'
 "
}
...
function cre_high_flow_parts(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/assistant/high_flow_parts/'
 "
}
...
hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/assistant/customer_mark/'
 "
}
...
hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/assistant/db_base/'
 "
}
function cre_filter(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/assistant/filter/'
 "
}
...
hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/assistant/engine_oil/'
 "
}
...
function cre_maintnance(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/assistant/maintnance/'
 "
}
...
function cre_kpi_total(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_total/'
 "
}
...
function cre_kpi_a_level(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_a_level/'
 "
}
...
function cre_kpi_b_level(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_b_level/'
 "
}
...
function cre_kpi_agetype(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_agetype/'
 "
}
...
function cre_kpi_bnbw(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_bnbw/'
 "
}
...
function cre_kpi_a_agetype(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_a_agetype/'
 "
}
...
function cre_kpi_b_agetype(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_b_agetype/'
 "
}
...
function cre_kpi_a_bnbw(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_a_bnbw/'
 "
}
...
function cre_kpi_b_bnbw(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_b_bnbw/'
 "
}
...
function cre_kpi_total_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_total_chev/'
 "
}
...
function cre_kpi_a_level_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_a_level_chev/'
 "
}
...
function cre_kpi_b_level_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_b_level_chev/'
 "
}
...
function cre_kpi_agetype_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_agetype_chev/'
 "
}
...
function cre_kpi_bnbw_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_bnbw_chev/'
 "
}
...
function cre_kpi_a_agetype_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_a_agetype_chev/'
 "
}
...
function cre_kpi_b_agetype_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_b_agetype_chev/'
 "
}
...
function cre_kpi_a_bnbw_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_a_bnbw_chev/'
 "
}
...
function cre_kpi_b_bnbw_chev(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/kpi_b_bnbw_chev/'
 "
}
...
function cre_label_doss(){
 hive -e "
  ...
  fields terminated by '\001'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/label/doss/';
 "
}
...
function cre_mark_order(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/assistant/mark_order/'
 "
}
...
function cre_mark_doss(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/assistant/mark_doss/'
 "
}
...
function cre_jipanshu(){
 hive -e "
  ...
  fields terminated by '\t'
  lines terminated by '\n'
  location 'hdfs://ns1/user/${user_name}/${TB_FACT}/auto/kpi/jipanshu/'
 "
 }
#cre_kpi_total
#cre_kpi_a_level
