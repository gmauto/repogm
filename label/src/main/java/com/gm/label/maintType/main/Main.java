package com.gm.label.maintType.main;


import com.gm.label.maintType.map.MyMap;
import com.gm.label.maintType.reduce.MyReduce;
...
public class Main extends Configured implements Tool {
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "label_maint_type");
