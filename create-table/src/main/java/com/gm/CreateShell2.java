...
/**
 * Created by jason on 2017-05-13.
 */
public class CreateShell2 {
    //用于存放function的名字
    ...
    public static void createShell(String filename) throws IOException {
        ...
        PrintWriter writer = new PrintWriter(new BufferedWriter(new OutputStreamWriter(new FileOutputStream("C:\\Users\\Administrator\\Desktop\\kpi_test.sh"), "utf-8")), true);
        String line;
        boolean flag = false;
    ...
    public static void make(List<String> list, PrintWriter writer) {
        ...
        writer.println("#" + line0 + "\n" +
                ...
                "  echo \"" + tableName + "_${mon_p}_${kpi}  $?\" >> ../log/res_test\n" +
                "}\n");
    }
