...
public class PyUtil {
    ...
    public static void printStart(PrintWriter writer) {
        ...
        writer.println("global pub_db");
        writer.println("global district");
        writer.println("global everymonth ");
        writer.println("global begin_day");
        writer.println("global end_day ");
        writer.println("global region");
    ...
    public static void printEnd(PrintWriter writer) {
        ...
        for (String s : funcList) {
            ...
            String flushfile = "time_record.flush()";
            list.add(starttime);
            list.add(func);
            list.add(endTime);
            list.add(overMark);
